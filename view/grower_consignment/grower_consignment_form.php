...
<main>
    ...
    <section>
        <header id="head">
            <h1><?php echo $user->getFirstName(); ?></h1>
        ...
        <form id="consignment_form" name="consignment_form" action="grower_consignment_controller.php" method="post">
            <div class="form_box">
                ...
                <div id="consignment_main">
                    ...
                    <div id="consignment_entry1" class="consignment_box">
                        <h2>Entry 1</h2>
                        ...
                        <div class="consignment_add_remove">
                            ...
                            <button class="consignment_button remove_entry" type="button">
                                ...
                                <div class="button_text">Delete Entry</div>
                            </button>
                        </div>
                    </div>

                </div class="submitLogoutbutton_container">
